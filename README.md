...
- **Python** by [François HU](https://curiousml.github.io/)
  ...
  - **Exam** : [2024.05.07 Exam (Available)](teaching/epita-python/2024_firstname_lastname.ipynb)
...
- **Bayesian Machine Learning** by [François HU](https://curiousml.github.io/)
  ...
  - **Lecture 4** : Causal Inference [[Lecture](./teaching/epita-BML/bayes_4_causal.pdf)]
...
- Lecturer on Data Science
   ...
   - **Description Projet** : [[Projets](./teaching/ISFA/projet_recherche_abidjan.pdf)]

- Practical Work on Actuarial Data Science
   - TP1 EDA in insurance [[Notebook](./teaching/ISFA/01_EDA_freMPL.ipynb)]
   ...
   - **freMTPL2freq Dataset** [[Dataset](./teaching/challenge/freMTPL2freq.xlsb)]
