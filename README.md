...
- **Apr.2019-2022 (Award for the best thesis in Actuarial Science)**: PhD thesis in Statistical/Machine Learning and Insurance at [Institut Polytechnique de Paris](https://www.ip-paris.fr/) ([CREST](http://crest.science/)-[ENSAE](https://www.ensae.fr/)) entitled *Semi-supervised learning in insurance: Fairness and Labeling* was supervised by [Caroline HILLAIRET](https://sites.google.com/site/carolinehillairet/home) and [Romuald ELIE](https://perso.math.u-pem.fr/elie.romuald/elie.html).
