...
- **2023** [Mitigating Discrimination in Insurance with Wasserstein Barycenters](https://arxiv.org/abs/2306.12912). BIAS (*ECML-PKDD Workshop*).
A. Charpentier, F. Hu and P. Ratz.

- **2023** [Fairness in Multi-Task Learning via Wasserstein Barycenters](http://arxiv.org/abs/2306.10155). ECML-PKDD (*Research Track*).
